...
(01, 'pavansai', 'pavan@gmail.com', 'i want to read more articles', '2021-09-18 21:46:36'),
(02, 'manasa', 'manasa@gmail.com', 'i want to know more', '2021-09-18 21:47:11'),
(34, 'divya', 'divya@gmail.com', 'i want to know more', '2021-09-18 21:47:45'),
(12, 'navya', 'navya@gmail.com', 'soman', '2022-09-18 21:57:21'),
(13, 'lahari', 'laharigmail', '$c_text', '2020-09-20 20:13:07'),
(06, 'dilip', 'dilip@gmail.com', 'sonam kapoore', '2020-09-20 20:14:16'),
(10, 'sai', 'sai@gmail.com', 'sonam kapoore', '2021-09-20 20:14:44'),
(31, 'harsha', 'harsha@gmail.com', 'hm', '2021-09-20 20:14:57'),
(28, 'purusotham', 'purusotham@gmail.com', 'hm', '2022-09-20 20:15:40'),
(37, 'qqq', 'akira@gmail.com', 'hm', '2019-09-20 20:16:41'),
...
(1, 'Dr.pavansai', 'kumar', 'pavansai@gmail.com', '880 2 9660015-19', 'medicine', 'MBBS, MRCP ( anakapalle ) , ECFMG ( india ) ,', '2001-12-04', 'male', 56867, 'nakkapalle,anakapalle district, anakapalle ', 'pavansai', '0000-00-00', 'Approved'),
(1234017, 'Dr.harsha', 'vardhan', 'harsha@gmail.com', '01711911821', 'medicine', 'MBBS, DTCD, FCPS Associate Professor & Head of Department', '2001-08-26', 'male', 56766, 'Thotada , anakapalle,andhra pradesh', 'harsha', '2018-09-08', 'Approved'),
(1234018, 'Dr.dilip', 'balla', 'dilip@gmail.com', '01717351631', 'medicine', 'MBBS, FCPS Associate Professor', '2002-06-23', 'male', 56767, 'sindiya,gajuwaka,vishakapatnam', 'dilip', '2018-09-08', 'Approved'),
(1234019, 'Dr.purusotham', 'ram', 'purusotham@gmail.com', '01717351631', 'medicine', 'MBBS, FCPS ( Medicine ), MD ( Internal Medicine ), MACP (anakapalle) Associate Professor', '2001-02-28', 'male', 56768, 'Thotada,anakapalle,andhra pradesh', 'purusotham', '2018-09-08', 'Approved'),
(1234020, 'Dr.N.S.S. navya ', 'sri', 'navya@gmail.com', '01729350383', 'medicine', 'MBBS, FCPS Associate Professor', '2002-09-29', 'female', 56769, 'nakapalle,anakapalle district,andhra pradesh', 'navya', '2018-09-08', 'Approved'),
(1234021, 'Dr.manasa', ' ganisetti', 'manasa@gmail.com', '01715024100', 'medicine', 'MBBS, FCPS Associate Professor', '2002-05-01', 'female', 56770, 'kondapur,anakapalle, andhra pradesh', 'manasa', '2018-09-08', 'Approved'),
(1234022, 'Dr. divya', ' reddy', 'divya@gmail.com', '01728401661', 'Orthopedic', 'MBBS, MS (Ortho.), DNB (Ortho.),Consultant', '2003-09-02', 'female', 56771, 'Apolo Hospital,Location: kondapur,anakapalle , andhra pradesh', 'divya', '2018-09-08', 'Approved'),
(1234023, 'Dr.Sisti ', ' sai', 'sistisai@gmail.com', '01711701234', 'Orthopedic', 'MBBS, MS ( Ortho ),Assistant Professor', '2001-01-03', 'male', 56772, 'kasimkota , anakapalle , andhra pradesh', 'sai', '2018-09-08', 'Approved'),
(1234024, 'Professor Dr . vinay', 'kumar', 'vinay@gmail.com', '01711701234', 'Orthopedic', 'Qualification : MBBS, MS, FICS Designation: Professor & Director', '2002-10-02', 'male', 56772, 's.annavaram , tuni , andhra pradesh', 'vinay', '2018-09-08', 'Approved'),
(1234026, 'Dr.deepthi', 'setty', 'Deepthi@gmail.com', '01711701234', 'Orthopedic', 'MBBS,.MS(Ortho) Designation : Associate Professor', '2002-09-15', 'female', 56778, 'narsipatnam, andhra pradesh', '123456789', '2018-09-08', 'Pending'),
(1234027, 'Dr. shailu', 'kanigiri', 'shailu@gmail.com', '01711701234', 'gynecologist', 'MBBS, FCPS (Gynae & Obs) Professor of Obstetrics & Gynaecology and Academic Coordinator', '2001-09-02', 'female', 56773, 's.annavaram , tuni , andhra pradesh', 'shailu', '2018-09-08', 'Approved'),
(1234028, 'Dr. mounika', 'ganta', 'mounika@gmail.com', '01711701234', 'gynecologist', 'MBBS, DGO, MCPS, FCPS Consultant', '1981-09-28', 'female', 56775, 'arilova,vishakapatnam , andhra pradesh ', 'mounika', '2018-09-08', 'Approved'),
(1234029, 'Dr. vasu', 'koppana', 'vasu@gmail.com', '01711701234', 'gynecologist', 'MBBS, DGO, FCPS, Fellow Reproductive Medicine ', '1999-09-24', 'male', 567780, 'Apollo Hospital,s.annavaram , tuni , andhra pradesh ', 'vasu', '2018-09-08', 'Approved'),
(1234030, 'Dr. lavanya', 'karri', 'lavanya@gmail.com', '01711701234', 'gynecologist', 'MBBS,MCPS,  FCPS (BCPS), MS(Gynae&Obs.),', '2001-09-10', 'female', 56781, 'Apollo Hospitals arilova , vishakapatnam , andhra pradesh', '2018-09-08', 'Pending'),
...
(5, 0, 'very nice', 'navya@gmail.com', '2018-09-07 18:08:06'),
(6, 0, 'good one', 'vinay@gmail.com', '2018-09-07 18:08:40'),
(7, 0, 'nice', 'pavan@gmail.com', '2018-09-07 18:09:40');
...
(1, 'pavansai', 'kumar', 'pavan@gmail.com', '01867785022', 'nakkapalle', '2001-12-08', 'male', 'single', 'pavan', '0000-00-00'),
(6, 'dilip', 'balla', 'dilip@gmail.com', '01867785022', 'sindiya', '2002-08-18', 'male', 'single', 'dilip', '2018-08-03'),
(7, 'vinay', 'kumar', 'vinay@gmail.com', '01867785022', 'null', '2002-08-26', 'male', 'single', 'vinay', '2018-08-03'),
(12, 'navya', 'sri', 'navya@gmail.com', '1', 'null', '2002-08-25', 'female', 'single', 'navya', '2018-08-06'),
(13, 'lahari', 'reddy', 'lahari@gmail.com', '01711701234', 'sindiya', '2003-04-04', 'female', '', 'lahari', '0000-00-00'),
(13, 'deepthi', 'setty', 'deepthi@gmail.com', '01711701212', '', '1996-04-04', 'female', '', 'deepthi', '0000-00-00'),
